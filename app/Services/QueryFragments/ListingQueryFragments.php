...
class ListingQueryFragments
{
    ...
    {
        $selectColumns = ["{$this->codeToSql['PRÉFECTURE']} AS area_code_prefecture"];
        $whereConditions = ['(cons_is_deleted <> 4 or cons_is_deleted is null)'];
        $fromTables = [];

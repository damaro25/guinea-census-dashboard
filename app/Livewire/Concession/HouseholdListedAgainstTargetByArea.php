...
class HouseholdListedAgainstTargetByArea extends Chart
{
    ...
    public function getData(string $filterPath): Collection
    {
        try {
            ...
            $data = $data->map(function ($area) use ($day_count_yesterday, $days_Since_enum_start, $total_Enum_days) {
                ...
                $area->txt = _("Total target:")." <b>".$area->ref_value."</b><br>"._("Today's target: ")."<b>".$area->expected_no
                    ."</b><br>"._("Yesterday's target:")." <b>".$area->expected_no_yesterday.'</b><br>'._('Enumerated HHs: <b>').$area->total._('</b>');
                return $area;
            });

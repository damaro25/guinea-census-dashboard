...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <main class="lg:relative flex-grow">
            ...
            <div class="relative w-full h-64 sm:h-72 md:h-96 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 lg:h-full bg">
                <img class="absolute inset-0 h-full object-center object-cover min-w-96" src="{{ asset('images/hero.png', config('chimera.secure')) }}" alt="">
            </div>
        </main>

        ...
        <div class="mt-2 flex flex-col">
            <div class="inline-block min-w-full py-2 align-middle">
                <div class="p-2 text-sm text-gray-500">
                    Filter
                    @if (is_null($filter))
                        : {{__('click on the rounded badges to filter to that data source')}}
                    @else
                ...
                <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-300">
                        ...
                        <tr>
                            <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">{{__('Report')}}</th>
                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">{{__('Generation Schedule')}}</th>
                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">{{__('Current Version')}}</th>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="w-full">
                                        <div class="font-medium text-gray-900">
                                            ...
                                            <a href="?filter={{ $report->data_source }}" class="border border-purple-200 inline-flex rounded-full bg-purple-100 px-2 leading-5 text-purple-800 items-center">
